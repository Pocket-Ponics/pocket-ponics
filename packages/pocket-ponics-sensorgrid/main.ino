...
String GetMCUData(int tierNum){
  ...
  String wlResVal = String((digitalRead(wlSensorBWR) == 0) ? 0 : 100);
  String nlResVal = String((digitalRead(wlSensorBNR) == 1) ? 0 : 100);
  
  
  mcuData = mcuData + ecValue +" "+ pHValue +" "+ wlValue+" "+ wlResVal+" "+ nlResVal;
